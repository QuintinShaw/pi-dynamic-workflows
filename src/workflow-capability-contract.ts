...
const capabilities: readonly CapabilityDescriptor[] = [
  runtimeGlobal("agent", {
    ...
    constraints: [
      ...
      "selector priority is explicit model > agentType model > tier > phase model > metadata model > active parent model > implicit medium > persisted Pi default",
      "if the selected model or route is unavailable, execution falls directly to the persisted Pi default rather than trying lower-priority selectors",
